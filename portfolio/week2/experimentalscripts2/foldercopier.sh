...
#Request user to type their desired name for the newly created copy of 'folderName'
    ...
    read -p "type your desired name for the newly copied folder: " newFolderName 
...
#Inform the user that their folder 'folderName' has been copied and is named 'newFolderName'.
    ...
    echo "Thank you. Your folder '$folderName' has been copied as '$newFolderName' to the current directory."
    exit 0
