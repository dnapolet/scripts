...
# Start of script
    ...
    read -p "type the name of the folder you would like to create: " folderName # Ask user to enter the name of the new folder, and capture that variable as 'folderName'
